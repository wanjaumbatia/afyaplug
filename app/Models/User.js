...
class User extends Orm_1.BaseModel {
    ...
    get isAdmin() {
        return this.roleId === Roles_1.default.ADMIN;
    }
    async sendVerifyEmail() {
        const token = await Token_1.default.generateVerifyEmailToken(this);
        console.log(token);
    }
}
__decorate([
...
__decorate([
    (0, Orm_1.hasMany)(() => Token_1.default),
    __metadata("design:type", Object)
...
__decorate([
    (0, Orm_1.hasOne)(() => SpecialistProfile_1.default),
    __metadata("design:type", Object)
