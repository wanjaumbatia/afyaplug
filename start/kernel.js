...
Server_1.default.middleware.registerNamed({
    ...
    verifyEmail: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]("App/Middleware/VerifiedEmail"))),
    staffProfile: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]("App/Middleware/StaffProfile"))),
});
